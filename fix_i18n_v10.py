# Fix i18n.ts: remove corruption artifacts
...
for i, raw_line in enumerate(raw_lines):
    ...
    # Remove trailing ? and \r (artifacts)
    while value_content and value_content[-1:] in (b'?', b'\r'):
        value_content = value_content[:-1]
    
    # Convert raw UTF-8 bytes to \uXXXX
